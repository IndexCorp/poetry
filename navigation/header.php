...
<head>
	...
	<meta property="og:description" content="We are so grateful to all of our partner-poets for sharing their work with us—please enjoy their beautiful words in our Featured Poetry catalogue." />
	...
	<header class="site-header text-dark">
		<div class="container position-relative d-flex justify-content-between align-items-lg-center py-3 py-lg-0">
			...
			<nav class="w-100 d-flex flex-wrap justify-content-end align-items-center">
				<ul id="menu-main-menu" class="menu list-unstyled d-lg-flex flex-wrap align-items-center mb-0"><li id="menu-item-12" class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-12"><a href="poetry.php" aria-current="page">Poetry</a></li>
